...
function check_extensions(): void
{
	...
	$required_extensions = ['gd', 'mysqli', 'pdo_mysql', 'pdo_sqlite', 'curl', 'fileinfo', 'intl', 'exif', 'mbstring',];
...
function get_image(mixed $file = '',string $type = 'post'):string
{
	...
	if($type == 'user'){
		return ROOT_URL."/assets/images/user.png";
	}else{
		return ROOT_URL."/assets/images/no_image.png";
	}
